...
class LedgerConnection extends baseConnection_1.BaseConnection {
    ...
    static async createActor(delegationIdentity, ledgerCanisterId, host) {
        const actor = await baseConnection_1._createActor(ledger_idl_1.default, ledgerCanisterId !== null && ledgerCanisterId !== void 0 ? ledgerCanisterId : constants_1.LEDGER_CANISTER_ID, delegationIdentity, host);
        return actor;
    }
    ...
    static async actorGetBalance(actor, account) {
        const response = await baseConnection_1.executeWithLogging(() => actor.account_balance_dfx({ account }));
        return response.e8s;
    }
    static async actorSend(actor, { to, amount, sendOpts, }) {
        const response = await baseConnection_1.executeWithLogging(() => {
            var _a, _b, _c;
            ...
            const subAccount = (sendOpts === null || sendOpts === void 0 ? void 0 : sendOpts.from_subaccount) === undefined
                ? []
                : Array.from([converter_1.fromSubAccountId(sendOpts === null || sendOpts === void 0 ? void 0 : sendOpts.from_subaccount)]);
