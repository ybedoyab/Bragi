...
export class IC extends ICWindow {
    constructor(authClient, agent) {
        ...
        this.handleAuthenticated = async ({ ledgerCanisterId, ledgerHost }) => {
            ...
            __classPrivateFieldSet(this, _localLedger, LedgerConnection.createConnection(this.getAuthClient().getInnerKey(), this.getAuthClient().getDelegationIdentity(), ledgerCanisterId, actorResult.actor, __classPrivateFieldGet(this, _agent)));
        };
    ...
    static async create(config) {
        var _a, _b, _c;
        const authClient = await AuthClient.create(Object.assign(Object.assign({}, config), { idpWindowOption: config.useFrame === true
                ? FRAME_SETTING
                : undefined }));
    ...
    async connect(connectOptions) {
        ...
        await new Promise((resolve, reject) => {
            ...
            this.getAuthClient().login({
                ...
                permissions: (_b = connectOptions === null || connectOptions === void 0 ? void 0 : connectOptions.permissions) !== null && _b !== void 0 ? _b : [PermissionsType.identity],
                onSuccess: async () => {
                    var _a, _b, _c, _d;
