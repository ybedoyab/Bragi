...
import { idlFactory } from './usuarios_frontend.did.js';
export { idlFactory } from './usuarios_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_USUARIOS_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./usuarios_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the usuarios_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./usuarios_frontend.did.js")._SERVICE>}
 */
export const usuarios_frontend = createActor(canisterId);
