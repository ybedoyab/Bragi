...
import { idlFactory } from './usuarios_backend.did.js';
export { idlFactory } from './usuarios_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_USUARIOS_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./usuarios_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the usuarios_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./usuarios_backend.did.js")._SERVICE>}
 */
export const usuarios_backend = createActor(canisterId);
